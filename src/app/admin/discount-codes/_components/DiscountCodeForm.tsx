...
export function DiscountCouponForm({products}:{products:{name:string,id:string}[]}){
    ...
    return <form action={action} className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <div className="text-muted-foreground">Leave Blank for Inifinte Uses</div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Label htmlFor="allProducts">AllProducts</Label>
        </div>
