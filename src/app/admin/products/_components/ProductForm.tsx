...
export function ProductForm({product}:{product?:Product|null}){
    ...
    return <form action={action} className="space-y-8">
        ...
        <div className="space-y-2">
            <Label htmlFor="priceInCents"> Price In Cents
            </Label>
        ...
        <div className="space-y-2">
            ...
            {product !=null && (<Image src="/products/6e5a2229-fb87-4ecd-a5a1-9c08f975ec6c-perry.jpg" alt="product" height={400} width={400}></Image>)}
